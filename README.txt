From Codecademy- Project after Loops Lesson in JavaScript Course


Directions copied from codecademy
...
fulfill all of these requirements, and you should expect to use the internet, Codecademy, and 
...
As you progress through the steps, use the terminal and console.log() statements to check the 
output of your loops and functions.